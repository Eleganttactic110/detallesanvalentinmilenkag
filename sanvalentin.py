...
<body>
    ...
    <div id="content1" class="content">
        ...
        <h1>💌Carta💌</h1>
        <p class="letter">Querida Señorita Milenka Guerrero🌹,</p>
        ...
        <p class="letter">Milenka, la verdad es importante para mi poder decirte en este dia conmemorativo lo mucho uqe te amo, el sentimiento que tengo por ti desde hace años, aun recuerdo la primera vez que te vi como un angel, cuando cantabas en inglés la canción "Diamonds" de Rihanna, tu voz es muy hermosa y en si tus cualidades, tu belleza y tu inteligencia te hacen la mujer perfecta, aunque nunca pense enamorarme de ti, nunca saliste de mi cabeza y tiempo despues me di cuenta lo mucho que valias y lo importante que te habias convertido para mi y asi me enamore de ti. Ademas, es importante resaltar que para mi no hay otra mujer, si te busco y te digo que me encnatas es por que desde el fondo de mi corazón te lo digo y mis sentimientos por ti son reales, quiero amarte y apoyarte incondicionalmente y ya no quiero perder el tiempo estando lejos de ti, estando lejos de la mujer que amo y me encanta es por eso que te queria preguntar de nuevo y queria pedirte: </p>
        <p class="letter">🌹"Podrias darme una oportunidad de conocerte y conquistarte, asi mismo de demostrarle que sin importar la distancia y diferencias podemos conocernos e inondicionalmente amarte y respetarte como te lo mereces, podrias darme esta oportunidad? Por favor"🌹</p>
        <p class="letter">Ya sea que aceptes o no, la verdad quiero que sepas que si te busque varias veces es por que cada palabra que digo o te escribo es real, cada carta que te escribi contenia un poco del amor que por ti sentia y sigo sintiendo hoy en dia, asi mismo como te indique en un mensaje tu y yo ya nos conocemos lo suficiente como para saber si quieres ser solo mi amiga o si siendo amigos podriamos llegar a ser algo mas, la verdad no quiero que se repita lo que ya vivimos donde tu y yo hablabaos bien, pero a la final te fuiste con alguien mas y ya sabes el resto, yo solo quiero que seas honesta conmigo como te dije no quiero ser solo tu amigo yo te amo de verdad, porfavor piensalo y dime con honestidad si podrias llegar a amarme o si solo me ves como un amigo. Piensalo por favor bonita.</p>
    ...
    <div id="content2" class="content">
        <button class="back-button" onclick="goBack()">Regresar</button>
        <h1>❤🎶Cancion❤🎶</h1>
        <p class="letter">Mi estimada y querida Brigadier le dedico estas dos canciones que me recuerdan a ti, disculpa si no son los ritmos que capaz te gustan pero te pido leas la siguiente descripción de cada canción y asi mismo si es posible las abras en una pestaña diferente por favor, gracias</p>
    ...
    <div id="content3" class="content">
        ...
        <div class="acrostic-container">
            ...
            <div class="acrostic">
                <p>M:ágica y especial, llena de vida todo lugar</p>
                <p>I:nteligente y siempre atenta, tiene un brillo único y singular</p>
                <p>L:uminosa en todos los sentidos</p>
                <p>E:ncantadora y juiciosa, acelera mis latidos</p>
                <p>N:aturalmente encantadora, ilumina mi vida con su sonrisa</p>
                <p>K:árita y única, como una cálida brisa</p>
